...
|---|---|---|---|
| Hero · título (`Hero.astro`) | Revenue Operations estratégico para transformar clínicas médicas em negócios de alta performance. | RevOps para transformar clínicas em negócios de alta performance. | Três linhas cheias na hero cansam antes da promessa chegar. Saem "estratégico" (adjetivo que não muda a promessa) e "médicas" (o site inteiro já fala de clínicas de saúde); "Revenue Operations" vira "RevOps", o termo da própria copy, que a cena de abertura acabou de cravar ("Isso é RevOps."). A promessa ("transformar… em negócios de alta performance") fica intacta. |
...
| "Nossos números" embaixo do texto de "O que a Renke faz" | Referência "Designing for impact": os números do briefing (~30 clínicas, 4 anos, R$42M, 1 por mês) ganham peso visual ao lado do vídeo, num carrossel com setas. Saiu do Sobre junto com a dobra. |
