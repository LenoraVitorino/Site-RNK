...
| Protocolo Revena: uma dobra só, com os cinco planos em cartões (um aberto, os outros com número, ícone e nome) | A copy trazia duas dobras que falavam a mesma coisa: os pilares em cards e, logo abaixo, os planos com "Organizamos seu processo comercial do zero em 90 dias" etc. Fundimos: os cartões (referência "Metafore") passam a ser os planos, com o ícone oficial, a fala do doutor, o texto do plano e o "Saiba mais"; o H3 "Estruturamos sua operação do zero…" vira o apoio do título. O trilho horizontal com a cortina (referência trionn) fica só na versão copy. Os pilares seguem nas páginas internas dos planos, onde o briefing os detalha. |
