...
| Palco dos planos com fundo claro (#D6D6D2, texto grafite), como a referência Tres Mares; ícone e nome multiplicam sobre o fundo | A única dobra clara da home: o preto absoluto vira moldura e os planos ganham o peso de "produto". O amarelo entra sólido nas peças do ícone, nunca como texto. O cabeçalho camaleão troca para o tom claro sozinho. Decisão da Lenora em 17/09. |
